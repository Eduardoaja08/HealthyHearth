...
class ModeloPerfil
{
    ...
    public static function mdlEditarPerfil($tabla, $id_perfil, $nombre, $apellidos, $correo, $telefono, $ocupacion, $genero)
    {
        try {
            $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET NOMBRE_USUARIO = :NOMBRE, APELLIDOS_USUARIO = :APELLIDOS_USUARIO, CORREO = :CORREO, TELEFONO = :TELEFONO, OCUPACION = :OCUPACION, GENERO = :GENERO WHERE ID_USUARIO = :ID_USUARIO");
