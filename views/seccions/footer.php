                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="footer-newsletter">
                            <h2>Suscribete como especialista</h2>
                            <p>
                                Si quieres poder formar parte de los especialistas de nutriología de nuestro catálogo puedes enviarnos tu correo.
                            </p>
                            <div class="form">
                                <input class="form-control" placeholder="Ingresa tu correo">
