...
class Pages {
    ...
    public function templates($page){
        ...
        if($page == 'about') {
            ...
            include 'views/moduls/shopping.php';
            include 'views/seccions/footer.php';
        } else if($page == 'order_detail'){
            include 'views/seccions/header.php';
            include 'views/seccions/navbar.php';
            include 'views/moduls/order_detail.php';
            include 'views/seccions/footer.php';
        } else if($page == 'products'){
            include 'views/seccions/header.php';
            include 'views/seccions/navbar.php';
            include 'views/moduls/products.php';
            include 'views/seccions/footer.php';
            ...
            include 'views/seccions/header.php';
            include 'views/seccions/navbar_user.php';
            include 'views/moduls/agendar.php';
            include 'views/seccions/footer.php';
        } else if($page == 'cat_medicos'){
            include 'views/seccions/header.php';
            include 'views/seccions/navbar_user.php';
            include 'views/moduls/cat_medicos.php';
            include 'views/seccions/footer.php';
        } else if($page == 'recommendations'){
            include 'views/seccions/header.php';
            include 'views/seccions/navbar_user.php';
            include 'views/moduls/recommendations.php';
            include 'views/seccions/footer.php';
        ...
        } else if($page == 'register_medico'){
            include 'views/moduls/register_medico.php';
        } else if($page == 'confi1'){
            include 'views/seccions/header.php';
            include 'views/seccions/navbar_doc.php';
