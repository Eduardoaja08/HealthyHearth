<main class="flex-1">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="text-center">Especialista en Nutriologia</td>
      <td class="text-center">
        <button class="btn btn-image-modal" onclick="openModal('imageModal2')">
          <i class="far fa-file-pdf text-3xl"></i>
        </button>
        <!-- Modal para la pdf -->
        <div
          id="imageModal2"
        ...
        >
          <div class="modal-content mx-auto my-12 max-w-sm">
            <button
              ...
              onclick="closeModal('imageModal2')"
            >&times;</button>
            <object
              type="application/pdf"
              data="views/documentos/curriculum.pdf"
      ...
      <td class="py-2 px-4 border-b text-center">
        <button class="btn btn-image-modal" onclick="openModal('imageModal1')">
          <img
      ...
      <td class="py-2 px-4 border-b text-center">
      <a href="?page=confi1"><button class="btn btn-edit"><i class="fas fa-check-circle"></i> Aceptar</button>
