                        ...
                        <div id="burgers" class="container tab-pane active">
                            <div class="row">
                                <div class="col-lg-7 col-md-12">
                                    <div class="menu-item">
                                        <div class="menu-img">
                                            <img src="views/img/menu-burger.jpg" alt="Image">
                                        </div>
                                        <div class="menu-text">
                                ...
                                <div class="col-lg-5 d-none d-lg-block">
                                    <img src="views/img/menu-burger-img.jpg" alt="Image">
                                </div>
                            </div>
                        </div>
                        <div id="snacks" class="container tab-pane fade">
                            <div class="row">
                                <div class="col-lg-7 col-md-12">
                                    <div class="menu-item">
                                        <div class="menu-img">
                                            <img src="views/img/menu-snack.jpg" alt="Image">
                                        </div>
                                        <div class="menu-text">
                                ...
                                <div class="col-lg-5 d-none d-lg-block">
                                    <img src="views/img/menu-snack-img.jpg" alt="Image">
                                </div>
                            </div>
                        </div>
                        <div id="beverages" class="container tab-pane fade">
                            <div class="row">
                                <div class="col-lg-7 col-md-12">
                                    <div class="menu-item">
                                        <div class="menu-img">
                                            <img src="views/img/menu-beverage.jpg" alt="Image">
                                        </div>
                                        <div class="menu-text">
                                ...
                                <div class="col-lg-5 d-none d-lg-block">
                                    <img src="views/img/menu-beverage-img.jpg" alt="Image">
                                </div>
                            </div>
                        </div>
                    </div>
