           ...
           <!-- Contenido va aquí -->
              <div class="max-w-sm rounded overflow-hidden shadow-lg" style="margin: 13px;">
                <div class="px-6 py-4">
                  ...
                  El numero de usuarios regristados en HealthHeart es de: 100 personas.
                  </p>
                </div>
              </div> <br>
              ...
              <div class="max-w-sm rounded overflow-hidden shadow-lg" style="margin: 13px;">
                <div class="px-6 py-4">
                  ...
                  <p class="text-gray-700 text-base">
                  El número de medicos regristados en HealthHeart es de: 25 medicos
                  </p>
                </div>
              </div>
              ...
              <div class="max-w-sm rounded overflow-hidden shadow-lg" style="margin: 13px;">
                <div class="px-6 py-4">
                  <div class="font-bold text-xl mb-2">
                  <i class="fa fa-credit-card"></i> Venta de Proteina
                  </div>
                  <p class="text-gray-700 text-base">
                  La venta de proteinas en total es de: 15 piezas.
                  </p>
                </div>
              </div>
              ...
              <div class="max-w-sm rounded overflow-hidden shadow-lg" style="margin: 13px;">
                <div class="px-6 py-4">
                  <div class="font-bold text-xl mb-2">
                   <i class="fa fa-list-alt"></i> Productos
                  </div>
                  <p class="text-gray-700 text-base">
                  Productos en catalogo existente: 350 productos. 
                  </p>
                </div>
              </div>
              ...
              <!-- <div class="max-w-sm rounded overflow-hidden shadow-lg" style="margin: 13px;">
                <div class="px-6 py-4">
                  <div class="font-bold text-xl mb-2">
                  <i class="fas fa-seedling"></i> Planes Alimenticios
                  </div>
                  <p class="text-gray-700 text-base">
                  El número de ventas de planes alimenticios es de: 50 planes.
                  </p>
                </div>
              </div>-->
              ...
              <div class="max-w-sm rounded overflow-hidden shadow-lg" style="margin: 13px;">
                <div class="px-6 py-4">
                  <div class="font-bold text-xl mb-2">
                  <i class="fa fa-book"></i> Venta de libros
                  </div>
                  <p class="text-gray-700 text-base">
                  El número de ventas de libros es de: 15 libros.
                  </p>
                </div>
              </div>
